...
<div class="row">
    <div class="col-md-12">
        <a id="abc" href="<?php echo base_url("htmlcontroller/export/xml"); ?>" class="btn btn-warning">Xuất XML</a>
        <a id="abc" href="<?php echo base_url("htmlcontroller/export/insertdb"); ?>" class="btn btn-success">Insert database</a>
    </div>
    <div class="col-md-12">
       <?php
